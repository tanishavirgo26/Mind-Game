...
public class Score extends JFrame implements ActionListener {
 Score(String username,int score){
     ...
     ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("mind/game/icons/score.png"));
     ...
     JLabel l2=new JLabel("Thankyou" + username + "for playing this Mind Game");
