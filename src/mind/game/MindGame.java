...
public class MindGame extends JFrame implements ActionListener{ 
    JButton b1, b2;
    JTextField t1;
...
MindGame(){
    ...
    ImageIcon i1=new ImageIcon(ClassLoader.getSystemResource("mind/game/icons/login.jpeg"));
    JLabel l1=new JLabel(i1);
    l1.setBounds(0,0,600,500);
    add(l1);
    
    JLabel l2 = new JLabel("MindGame");
    l2.setFont(new Font("Comic Sans MS", Font.BOLD, 40));
    l2.setForeground(new Color(30, 144, 254));
    l2.setBounds(790, 60, 300, 45);
    add(l2);
